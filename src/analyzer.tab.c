...
static const yytype_int16 yyrline[] =
{
     ...
     342,   343,   343,   343,   349,   356,   356,   371,   372,   376,
     380,   381
};
#endif
...
static const char *const yytname[] =
{
  ...
  "functions", "function_params", "function_entry", "function", "type",
  "params", "params_void", "params_full_p1", "params_full", "block_entry",
  "block", "instructions", "instruction", "ifheader", "$@1", "condins",
  "$@2", "expr", "term", "condition", "loop", "$@3", "$@4", "print",
  "assign", "declar", "$@5", "$@6", "funcreturn", "funccall", "$@7",
...
#line 359 "analyzer.y"
                     {asm_add(ASM_PUSH, asm_push(), NIL, NIL, 1);
                      ...
                      asm_add(ASM_B, fun_get_addr((yyvsp[-4].s)), NIL, NIL, 1);
